...
import { NavParams, NavController, PopoverController, Platform, ToastController, AlertController } from '@ionic/angular';
import { LoadingService } from './../../../loading.service';
import {Http, Headers} from '@angular/http';
import { NFC, Ndef } from '@ionic-native/nfc/ngx';

@Component({
  selector: 'app-visitag',
  templateUrl: './visitag.page.html',
  styleUrls: ['./visitag.page.scss'],
})
export class VisitagPage implements OnInit {
  public apiUrl: string;
    ...
    constructor(private nav: NavController,
      ...
      private toastCtrl: ToastController, public navParams: NavParams) {
        ...
        this.stLPuntoID = navParams.get("stRPto");
      ...
      private SrBuscaPuntos() {
            this.apiUrl = 'http://wsoberon.azurewebsites.net/WSIdentificacion.asmx/getPuntosLlavesVisitaSUP';
            ...
            let params='stREmpleado=' + this.stLEmpleado +'&inRPuntoVisita=' + this.stLPuntoID;
      ...
      private SetWS()
     {
         ...
         if(data1["Table"] != null) {
           ...
           if(this.dataAux1[0].RESP=="0")
           {
             ...
             this.presentToast("Precinto Escaneado Exitosamente");
             this.getPuntosRonda();
           }
           else{
             this.presentToast("Error: El Precinto NO pudo ser Escaneado");
             //this.getPuntosRonda();
           }
         }
         else{
     ...
     private SrInsertaWS() {
       ...
       let headers = new Headers();
       headers.append('Content-Type', 'application/x-www-form-urlencoded');
       let params = 'stRTagID=' + this.tagId + '&inREstado=3' + '&stRValidacion=1' + '&stRUsuario=' + this.loading.m_Apellidos + ' ' +this.loading.m_Nombres +'&stREmpleado=' + this.stLEmpleado +"&stRPuntoID=" + this.stLPuntoID +'&stRUsuarioAPP=' + this.loading.m_UsuarioApp +'&stRPasswordAPP='+ this.loading.m_PasswordApp +'&stRCodigoWSAPP='+ this.loading.m_CodigoWSApp +'&stRIMEI='+ this.loading.m_IMEI;
       //let params='';
       return new Promise(resolve => {
         //this.http.post('http://192.168.3.8:1368/icwebmobile/consulta_puestos.php', creds, {headers: headers})
         this.http.post(this.apiUrl,params,{headers: headers}).subscribe(data => {
      ...
      private SrBuscaPuntosBusqueda(stRBusqueda) {
            this.apiUrl = 'http://wsoberon.azurewebsites.net/WSIdentificacion.asmx/getPuntosLlavesBusqVisitaSUP';
            console.log(this.apiUrl);
            //this.apiUrl = 'http://192.168.0.5:14757/WSIdentificacion.asmx/Identificacion?stRFoto='+stRFotoAux;
            //let creds = JSON.stringify({stRFoto: this.stRFoto});
            //postData.append('stRFoto' , stRFotoAux);
            ...
            //let params = 'stRUbicacionID=' + stRPuesto;
            //let params = 'stRUbicacionID=' + stRUbicacion + '&stRTipoPuntos=' + stRTipoPuntos +'&stREmpleado=' + this.loading.m_Empleado;
            let params='stRNombre=' + stRBusqueda + '&stREmpleado=' + this.stLEmpleado + '&inRPuntoVisita=' + this.stLPuntoID;;
            return new Promise(resolve => {
                //this.http.post('http://192.168.3.8:1368/icwebmobile/consulta_puestos.php', creds, {headers: headers})
                this.http.post(this.apiUrl,params,{headers: headers}).subscribe(data => {
                    if(data.json()!=null){
